...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2018 at 08:51 AM
...
--
ALTER TABLE `images`
  MODIFY `ImageID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `ProductID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
