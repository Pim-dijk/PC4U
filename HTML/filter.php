...
<body>
<form action="#">
          <h3 style="font-weight: bold">Merk</h3>
            <select id="merk">
          ...
          <h3 style="font-weight: bold">Sorteren op prijs</h3>
          ...
          <h3 style="font-weight: bold">Processortype</h3>
            <select id="processor">
          ...
          <h3 style="font-weight: bold">Schermgrootte</h3>
            <select id="scherm">
