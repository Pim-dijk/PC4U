        ...
        <div class="col-xs-12">
            ...
            <form class="center-block myForm needs-validation" method="POST" action="retourneren_aanvraag.php" >
                ...
                <div class="form-group required col-lg-4 col-sm-6 col-xs-12">
                    ...
                    <input type="number" class="form-control" name="OrderID" id="OrderID" placeholder="Ordernummer"
                ...
                <div id="hiddenTextArea" class="form-group col-lg-12 hidden">
                    ...
                    <textarea type="text" class="form-control textAreaInput" name="Message" id="Message" placeholder="Toelichting..."></textarea>
                </div>
