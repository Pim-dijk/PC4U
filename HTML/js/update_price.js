function updatePrice(id) {
    ...
    var totalPirceProduct = totalPriceProductValueSplitString[1];
    ...
    var sumTotal = sumTotalElementValueSplitString[1];

    var oldTotalPriceProductValue = totalPriceProductElement.textContent;
    var oldTotalPriceProductValueSplitString = oldTotalPriceProductValue.split(" ");
    var oldTotalPriceProduct = oldTotalPriceProductValueSplitString[1];

    var newTotalPriceProduct = amount * productPrice;

    sumTotal -= oldTotalPriceProduct;
